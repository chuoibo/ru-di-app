...
- `byte_size` là độ dài đầu ra của Pillow. ADR-0029 §2.8 cho JPEG lệch byte (SSIM), nhưng thân JSON và hàng DB mang `byte_size` phải bằng nhau; mâu thuẫn này đã ghi trong `docs/team/hang-doi.md` và chờ số đo nén lại giống từng byte.
