...
- `PUT /people/me/saved-places/{place_id}`: Chỉ bị cổng nối theo tên hàm (`_open_paper_id`, `pair_notebook`, repository) kéo vào — hành vi không đổi.
...
- `PUT /people/me/saved-places/{place_id}`: Chỉ bị cổng nối theo tên hàm kéo vào — hành vi không đổi.
