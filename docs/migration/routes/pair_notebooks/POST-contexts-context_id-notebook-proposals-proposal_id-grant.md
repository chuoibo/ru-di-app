...
- `POST /contexts/{context_id}/notebook/proposals/{proposal_id}/grant`: Chỉ bị cổng nối theo tên hàm (`_open_paper_id`, `pair_notebook`, repository) kéo vào — hành vi không đổi.
...
- `POST /contexts/{context_id}/notebook/proposals/{proposal_id}/grant`: Chỉ bị cổng nối theo tên hàm kéo vào — hành vi không đổi.
