...
- `POST /contexts/{context_id}/meet`: Chỉ bị cổng nối theo tên hàm (`_open_paper_id`, `pair_notebook`, repository) kéo vào — hành vi không đổi.
...
- `POST /contexts/{context_id}/meet`: Chỉ bị cổng nối theo tên hàm kéo vào — hành vi không đổi.
