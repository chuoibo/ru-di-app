...
trước đợt gộp được ghi trong [biên bản merge](../../2026-09-13/merge-hanh-trinh-main.md).
Quyết định sản phẩm nằm trong
[ADR-0028](../../../decisions/ADR-0028-hanh-trinh-ban-do-cua-hoi.md).
...
Trạng thái gộp mới hơn nằm trong biên bản merge; chưa deploy production.
