...
- `node docs/archive/claude/2026-09-09/kiem-cong-ghi-cong.mjs`: 12/12 ca đạt, không whole-file bypass.
- `node docs/archive/codex/2026-09-09/native-audit-evidence/probe-late-context.mjs`: tái hiện F42. Exit 0 của probe nghĩa là **tái hiện lỗi lịch sử**, không phải app đã pass. Script cố ý assert lỗi còn hiện diện; khi sửa đúng cần chuyển thành regression test trong harness React.
