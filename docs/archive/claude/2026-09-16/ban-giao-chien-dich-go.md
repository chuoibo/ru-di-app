...
(luật chiến dịch) · `docs/decisions/ADR-0030-*.md` (lane Codex đóng, định nghĩa cổng) · `docs/team/hang-doi.md`
...
`docs/archive/claude/2026-09-17/review-phan-con-lai-go.md` §2.1.
