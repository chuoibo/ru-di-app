---json
{
  ...
  "di_toi": [
    ...
    {"nhan": "Mở kèo đã tạo", "man": "outings/[id]"}
  ],
  "tien": false
}
---
...
## Khi tờ hẹn đã thành kèo hoặc không đọc được

1. Tờ hẹn đã thành kèo rồi thì bấm «Mở kèo đã tạo» để tới đúng kèo đó.
2. Không đọc được tờ hẹn gốc thì bấm «Viết kèo mới» để tạo kèo từ đầu.
